...
| H-20260904-003 | TESTING | Integer-threshold Kalshi ladders (totals, yards) are mispriced at tails relative to a well-calibrated empirical distribution; market monotonicity violations exist within ladders. | backfill: 61,557 archived 2025 markets (33,684 settled player rungs, 7,420 spread rungs, 5,918 total rungs); model families evaluated on Kalshi's own rungs: positive Brier skill vs rung base rate for all stats, passing-y |
