...
| `H-20260904-022` | REGISTERED_PROSPECTIVE | 2026-09-05 (session 4): role features RETIRED from the shadow pricer.  | the sign and magnitude of the validated effect when re-measured on Kal | Effects validated on the full population will attenuate toward zero or reverse o |
...
| `H-20260916-028` | PROPOSED | — | PRIMARY: accuracy of the predicted starting quarterback against the re | The depth-chart-only baseline is already right on the large majority of team-gam |
