...
def health(rows: list, board_rows: list, markers: list, season: int, week: int) -> dict:
    ...
    return {"season": season, "week": week,
            ...
            "AUTOPSY_COVERAGE": {"data_arm_settled": sum(1 for r in with_p if r.get("model_arm") in ("DATA_PLAYER_DIST", "DATA_PLAYER_V3", "DATA_PLAYER_V4", "DATA_PLAYER_V5") and r.get("settled_yes") is not None),
