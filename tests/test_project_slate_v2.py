...
def test_v2_writes_only_under_its_own_tree_and_never_imports_the_incumbent_pricer():
    ...
    # the v2 arms are kept unchanged; the v3 arms (data-player-dist-3.0.0) are added beside them, never in place, and the
    # v4 arms (data-player-dist-4.0.0) after those, and the v5 arms (data-player-dist-5.0.0) after THOSE -- every earlier
    # arm stays exactly where it was
