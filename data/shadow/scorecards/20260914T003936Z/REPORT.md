# Shadow evaluation scorecard (20260914T003936Z)

## Sample units

| unit | observations | contracts | games |
|---|---|---|---|
| raw snapshots (correlated) | 22862 | 961 | 2 |
| **latest pregame per contract (primary)** | 961 | 961 | 2 |

The raw view holds 22862 snapshots of 961 contracts: they are repeated observations of the same markets and are reported as diagnostics, never as an independent sample size. No effective N is computed.

## What is in the corpus

| settlement status | n |
|---|---|
| REFUSED_PARTICIPATION_UNPROVEN | 70 |
| SETTLED | 22792 |
