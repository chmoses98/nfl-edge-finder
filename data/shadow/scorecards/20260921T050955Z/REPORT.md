# Shadow evaluation scorecard (20260921T050955Z)

## Sample units

| unit | observations | contracts | games |
|---|---|---|---|
| raw snapshots (correlated) | 183278 | 7499 | 17 |
| **latest pregame per contract (primary)** | 7499 | 7499 | 17 |

The raw view holds 183278 snapshots of 7499 contracts: they are repeated observations of the same markets and are reported as diagnostics, never as an independent sample size. No effective N is computed.

## What is in the corpus

| settlement status | n |
|---|---|
| REFUSED_PARTICIPATION_UNPROVEN | 5965 |
| SETTLED | 177313 |
