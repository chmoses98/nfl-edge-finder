# Shadow evaluation scorecard (20260921T130246Z)

## Sample units

| unit | observations | contracts | games |
|---|---|---|---|
| raw snapshots (correlated) | 306784 | 12795 | 31 |
| **latest pregame per contract (primary)** | 12795 | 12795 | 31 |

The raw view holds 306784 snapshots of 12795 contracts: they are repeated observations of the same markets and are reported as diagnostics, never as an independent sample size. No effective N is computed.

## What is in the corpus

| settlement status | n |
|---|---|
| REFUSED_PARTICIPATION_UNPROVEN | 7262 |
| SETTLED | 299522 |
