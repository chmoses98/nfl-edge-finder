# Shadow evaluation scorecard (20260918T045526Z)

## Sample units

| unit | observations | contracts | games |
|---|---|---|---|
| raw snapshots (correlated) | 174243 | 7086 | 16 |
| **latest pregame per contract (primary)** | 7086 | 7086 | 16 |

The raw view holds 174243 snapshots of 7086 contracts: they are repeated observations of the same markets and are reported as diagnostics, never as an independent sample size. No effective N is computed.

## What is in the corpus

| settlement status | n |
|---|---|
| REFUSED_PARTICIPATION_UNPROVEN | 4700 |
| SETTLED | 169543 |
