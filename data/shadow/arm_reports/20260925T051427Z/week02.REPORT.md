...
1003 player-stat-game projections diagnosed. Ranked by |robust z| of the actual inside the fitted distribution (cross-statistic), ties by game and player. Classification is deterministic from the recorded intermediates.
...
Classification counts over every diagnosed projection: {'EFFICIENCY_MISS': 186, 'UNEXPLAINED_VARIANCE': 28, 'TEAM_VOLUME_MISS': 74, 'OPPORTUNITY_MISS': 307, 'NO_LARGE_MISS': 382, 'INSUFFICIENT_DATA': 19, 'AVAILABILITY_MISS': 7}.
Missing usage (no snap table or stats row): 26.
