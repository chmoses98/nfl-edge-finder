...
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| T-24h | DATA_ONLY | margin | 15 | 4 | 1 | 2 | 8 | 0 | 0.333 [0.061, 0.792] | 0.364 | 0.364 | 0.00 |
| T-24h | DATA_ONLY | total | 15 | 3 | 5 | 1 | 6 | 0 | 0.833 [0.436, 0.970] | 0.500 | 0.417 | 0.46 |
| T-24h | HYBRID_30 (derived) | margin | 15 | 10 | 0 | 1 | 4 | 0 | 0.000 [0.000, 0.793] | 0.200 | 0.200 | -0.10 |
| T-24h | HYBRID_30 (derived) | total | 15 | 12 | 0 | 0 | 3 | 0 | - - | 0.333 | 0.333 | 0.00 |
| T-6h | DATA_ONLY | margin | 6 | 0 | 1 | 0 | 5 | 0 | 1.000 [0.207, 1.000] | 0.500 | 0.500 | 0.08 |
| T-6h | DATA_ONLY | total | 6 | 2 | 1 | 1 | 2 | 0 | 0.500 [0.095, 0.905] | 0.750 | 0.750 | 0.12 |
| T-6h | HYBRID_30 (derived) | margin | 6 | 2 | 0 | 0 | 4 | 0 | - - | 0.250 | 0.250 | 0.00 |
| T-6h | HYBRID_30 (derived) | total | 6 | 5 | 0 | 0 | 1 | 0 | - - | 1.000 | 1.000 | 0.00 |
| T-90m | DATA_ONLY | margin | 15 | 2 | 3 | 0 | 10 | 0 | 1.000 [0.439, 1.000] | 0.462 | 0.462 | 0.12 |
| T-90m | DATA_ONLY | total | 15 | 4 | 2 | 1 | 8 | 0 | 0.667 [0.208, 0.939] | 0.455 | 0.455 | 0.09 |
| T-90m | HYBRID_30 (derived) | margin | 15 | 9 | 0 | 0 | 6 | 0 | - - | 0.333 | 0.333 | 0.00 |
| T-90m | HYBRID_30 (derived) | total | 15 | 12 | 0 | 0 | 3 | 0 | - - | 0.333 | 0.333 | 0.00 |
| T-30m | DATA_ONLY | margin | 15 | 2 | 2 | 0 | 11 | 0 | 1.000 [0.342, 1.000] | 0.462 | 0.462 | 0.12 |
| T-30m | DATA_ONLY | total | 15 | 4 | 3 | 1 | 7 | 0 | 0.750 [0.301, 0.954] | 0.455 | 0.455 | 0.14 |
| T-30m | HYBRID_30 (derived) | margin | 15 | 9 | 0 | 0 | 6 | 0 | - - | 0.333 | 0.333 | 0.00 |
| T-30m | HYBRID_30 (derived) | total | 15 | 12 | 1 | 0 | 2 | 0 | 1.000 [0.207, 1.000] | 0.333 | 0.333 | 0.33 |
| latest_pregame | DATA_ONLY | margin | 16 | 2 | 2 | 0 | 12 | 0 | 1.000 [0.342, 1.000] | 0.429 | 0.429 | 0.11 |
| latest_pregame | DATA_ONLY | total | 16 | 4 | 3 | 1 | 8 | 0 | 0.750 [0.301, 0.954] | 0.417 | 0.417 | 0.12 |
| latest_pregame | HYBRID_30 (derived) | margin | 16 | 10 | 0 | 0 | 6 | 0 | - - | 0.333 | 0.333 | 0.00 |
| latest_pregame | HYBRID_30 (derived) | total | 16 | 12 | 1 | 0 | 3 | 0 | 1.000 [0.207, 1.000] | 0.250 | 0.250 | 0.25 |
...
| margin | 1-2 | 4 | 1 | 0 | 3 | 0 | 1.000 |
| margin | 2-3 | 4 | 1 | 0 | 3 | 0 | 1.000 |
| margin | 3-5 | 4 | 0 | 0 | 4 | 0 | - |
| margin | >5 | 2 | 0 | 0 | 2 | 0 | - |
| total | <=1 | 4 | 0 | 0 | 4 | 0 | - |
| total | 1-2 | 5 | 0 | 1 | 4 | 0 | 0.000 |
| total | 2-3 | 3 | 2 | 0 | 1 | 0 | 1.000 |
| total | 3-5 | 3 | 1 | 0 | 2 | 0 | 1.000 |
| total | >5 | 1 | 0 | 0 | 1 | 0 | - |

## Player projection autopsy (largest standardised misses; diagnosis, never a model change)

1004 player-stat-game projections diagnosed. Ranked by |robust z| of the actual inside the fitted distribution (cross-statistic), ties by game and player. Classification is deterministic from the recorded intermediates.
...
Classification counts over every diagnosed projection: {'EFFICIENCY_MISS': 186, 'UNEXPLAINED_VARIANCE': 28, 'TEAM_VOLUME_MISS': 74, 'OPPORTUNITY_MISS': 307, 'NO_LARGE_MISS': 382, 'INSUFFICIENT_DATA': 19, 'AVAILABILITY_MISS': 8}.
Missing usage (no snap table or stats row): 27.
