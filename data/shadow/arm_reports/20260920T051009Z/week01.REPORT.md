...
994 player-stat-game projections diagnosed. Ranked by |robust z| of the actual inside the fitted distribution (cross-statistic), ties by game and player. Classification is deterministic from the recorded intermediates.
...
Classification counts over every diagnosed projection: {'EFFICIENCY_MISS': 163, 'UNEXPLAINED_VARIANCE': 34, 'OPPORTUNITY_MISS': 379, 'NO_LARGE_MISS': 383, 'INSUFFICIENT_DATA': 18, 'AVAILABILITY_MISS': 17}.
